...
class DiskExportManager(object):
    ...
    def __init__(self, dst, disk_type, disk, do_compress=False):
        """
        Args:
            dst (str): The absolute path of the exported disk
    ...
    @staticmethod
    def get_instance_by_type(dst, disk, do_compress=False, *args, **kwargs):
        """
        Args:
...
class TemplateExportManager(DiskExportManager):
    ...
    def rebase(self):
        ...
        if self.standalone:
            ...
            parent = './{}'.format(os.path.basename(parent.split(':', 1)[1]))
